...
public class ProjectController {
    ...
    @PutMapping("/update")
    public void updateProject(@AuthenticationPrincipal CustomUserDetails userDetails, @Valid @RequestBody UpdateProjectDTO dto) throws InvalidInputException, UnauthorizedException {
        Long userId = userDetails.getId();
