...
export function Navbar() {
    ...
    return (
        <nav className={`hidden Navbar  bg-gray-400/50 dark:bg-slate-900/40 w-full h-25 md:flex justify-between items-center px-5 sm:px-10 text-black dark:text-white`}>
