...
const activeClasses = "underline dark:decoration-sky-500 decoration-2 underline-offset-10 font-bolder";
const inactiveClasses = "hover:bg-sky-200/20 dark:text-gray-300";
