                ...
                {[
                    {
                        ...
                        desc: "Tell us your stack, interests, and availability.",
                    },
                    ...
                    >
                        <div className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-emerald-500 text-white font-semibold">
                            {s.step}
                        </div>
