...
export function DashboardStatCard({ Icon, label, value, color }: DashboardStatCardProps) {
    return (
        <div className="bg-gradient-to-br from-white to-slate-100 dark:from-stone-800 dark:to-stone-900 space-y-3 aspect-square rounded-xl p-6 shadow-md flex flex-col items-start justify-start border border-slate-800">
