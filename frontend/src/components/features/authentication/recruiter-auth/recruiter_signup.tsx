...
export function RecruiterSignUp() {
    ...
    const { register, handleSubmit, getValues, formState: { errors } } = useForm<RecruiterSignUpRequestDTO>();
    ...
    const handleSignUp = (data: RecruiterSignUpRequestDTO) => {
        setLoading(true);
        authService.recruiterSignUp(data)
            .then(res => {
                ...
                <div className="w-full max-w-2xl">
                    ...
                    <div className="rounded-3xl border border-slate-200/70 bg-white/80 p-6 shadow-xl backdrop-blur dark:border-slate-700/60 dark:bg-slate-900/60">
                        ...
                        <div className="mb-6 text-center">
                            <h1 className="text-3xl font-bold">Create your Grouply Recruiter Account</h1>
                            <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Creates tasks and find talented developers.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit(handleSignUp)} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    {...register("firstName", { required: "First name is required", maxLength: { value: 40, message: "Max 40 chars" } })}
                                />
                            ...
                            {/* Company Name */}
                            <div className="sm:col-span-2">
                                <label htmlFor="email" className="mb-1 block text-sm font-medium">Company name</label>
                                <input
                                    id="company"
                                    type="text"
                                    ...
                                    {...register("companyName", {
                                        ...
                                        maxLength: {value: 40, message: "Less then 40 characters"},
                                        minLength: {value: 5, message: "At least 5 characters"}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 pr-10 text-sm shadow-sm transition placeholder:text-slate-400 focus:ring-2 dark:border-slate-700 dark:bg-slate-800"
                                        {...register("password", {
                            ...
                            <div className="sm:col-span-2 mt-1 text-center text-sm text-slate-600 dark:text-slate-300">
                                Already have an recruiter account?{" "}
                                <NavLink to="/recruiter/login" className="font-medium text-teal-600 hover:underline dark:text-teal-400">Sign in</NavLink>
                            </div>
                        </form>
                    </div>
